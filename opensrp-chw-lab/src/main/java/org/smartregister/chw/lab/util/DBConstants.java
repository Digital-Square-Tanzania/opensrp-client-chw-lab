...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String SAMPLE_REQUEST_DATE = "sample_request_date";
        public static final String SAMPLE_COLLECTION_DATE = "sample_collection_date";
        ...
        public static final String SAMPLE_LIST = "samples_list";
        public static final String RESULTS = "results";
        public static final String SAMPLE_PROCESSED = "sample_processed";
        public static final String MANIFEST_STATUS = "manifest_status";
        ...
        public static final String OUTLET_WARD_NAME = "outlet_ward_name";
        public static final String OUTLET_VILLAGE_STREET_NAME = "outlet_village_street_name";
